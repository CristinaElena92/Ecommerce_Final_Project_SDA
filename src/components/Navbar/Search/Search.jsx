...
const Search = () => {
  ...
  return (
    <div className="flex items-center justify-center p-2 md:p-0">
      <div className="flex items-center w-full max-w-md  rounded shadow-lg ">
        <input
          type="text"
          placeholder="Search..."
          value={searchTerm}
          onChange={(e) => setSearchTerm(e.target.value)}
          className="flex-grow p-2 border-none rounded-l focus:outline-none hover:shadow-lg hover:shadow-red-500/50 text-sm sm:text-base md:text-lg lg:text-md px-2 sm:px-4 py-1 transition-all duration-300"
        />
        <button
